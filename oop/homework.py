...
class Wall:
    ...
    * Implement method number_of_rolls_of_wallpaper which receives such parameters: roll_width_m, roll_length_m
    ...
    def number_of_rolls_of_wallpaper(self, roll_width_m, roll_length_m):
        roll_square = roll_width_m * roll_length_m
        return self.wall_square() / roll_square
...
class Roof:
    """
        ...
        * Implement method roof_square that returns square of the roof
          if roof_type eq "gable" the roof square is simple rectangle square formula multiplied 2
          if roof_type eq "single-pitch" the roof square is simple rectangle square formula
...
class Door:
    ...
    def update_wood_price(self, new_price_wood):
        self.wood_price = new_price_wood

    def update_metal_price(self, new_price_metal):
        self.metal_price = new_price_metal
...
class House:
    ...
    * Implement method get_room_square that returns the square of our room
    ...
    def __init__(self):
        self.__walls = []
        self.__windows = []
        self.__roof = None  # для чого ми тут ініціалізовували цю і наступну змінну зі значенням None?
        self.__door = None
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_length_m):
        ...
        rolls = []
        for wall in self.__walls:
            roll = wall.number_of_rolls_of_wallpaper(roll_width_m, roll_length_m)
            rolls.append(roll)
        return int(sum(rolls))
